...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* WebRequestUtils_MakeUriString_m5693EA04230335B9611278EFC189BD58339D01E4 (Uri_t87E4A94B2901F5EEDD18AA72C3DB1B00E672D68E * ___targetUri0, String_t* ___targetUrl1, bool ___prependProtocol2, const RuntimeMethod* method)
{
	...
	}
	{
		...
		StringBuilder__ctor_m786CAFE74FE0D479747A0D474BE6EBCFDA5743EA(L_14, L_11, L_13, /*hidden argument*/NULL);
		V_1 = L_14;
		...
		String_t* L_16 = V_0;
		bool L_17 = String_op_Equality_m139F0E4195AE2F856019E63B241F36F016997FCE(L_16, _stringLiteralF92E777F4341930BAD9B2422283C4680D00DBC06, /*hidden argument*/NULL);
		if (!L_17)
		{
			goto IL_00db;
		}
	...
	{
		Uri_t87E4A94B2901F5EEDD18AA72C3DB1B00E672D68E * L_18 = ___targetUri0;
		String_t* L_19 = Uri_get_AbsolutePath_mA9A825E2BBD0A43AD76EB9A9765E29E45FE32F31(L_18, /*hidden argument*/NULL);
		V_2 = L_19;
		String_t* L_20 = V_2;
		bool L_21 = String_Contains_m4488034AF8CB3EEA9A205EB8A1F25D438FF8704B(L_20, _stringLiteral4345CB1FA27885A8FBFE7C0C830A592CC76A552B, /*hidden argument*/NULL);
		if (!L_21)
		{
			goto IL_007c;
		}
	}
	{
		String_t* L_22 = V_2;
		IL2CPP_RUNTIME_CLASS_INIT(WebRequestUtils_tBE8F8607E3A9633419968F6AF2F706A029AE1296_il2cpp_TypeInfo_var);
		String_t* L_23 = WebRequestUtils_URLDecode_m3F75FA29F50FB340B93815988517E9208C52EE62(L_22, /*hidden argument*/NULL);
		V_2 = L_23;
	}
...
IL_007c:
	{
		String_t* L_24 = V_2;
		bool L_25 = String_StartsWith_m7D468FB7C801D9C2DBEEEEC86F8BA8F4EC3243C1(L_24, _stringLiteral947518D877FB275850A375D795BE6A44C27AB526, /*hidden argument*/NULL);
		if (!L_25)
		{
			goto IL_00c7;
		}
	...
	{
		String_t* L_28 = V_2;
		Il2CppChar L_29 = String_get_Chars_m14308AC3B95F8C1D9F1D1055B116B37D595F1D96(L_28, 6, /*hidden argument*/NULL);
	...
	}
	{
		...
		StringBuilder_Append_mDBB8CCBB7750C67BE2F2D92F47E6C0FA42793260(L_30, _stringLiteralA91E4897CA9F429677AFC57ED00D90DE8D3C7001, /*hidden argument*/NULL);
		StringBuilder_t * L_31 = V_1;
		String_t* L_32 = V_2;
		String_t* L_33 = String_Substring_m2C4AFF5E79DD8BADFD2DFBCF156BF728FBB8E1AE(L_32, 5, /*hidden argument*/NULL);
...
IL_00db:
	{
		...
		Uri_t87E4A94B2901F5EEDD18AA72C3DB1B00E672D68E * L_39 = ___targetUri0;
		String_t* L_40 = Uri_get_PathAndQuery_mF079BA04B7A397B2729E5B5DEE72B3654A44E384(L_39, /*hidden argument*/NULL);
		StringBuilder_Append_mDBB8CCBB7750C67BE2F2D92F47E6C0FA42793260(L_38, L_40, /*hidden argument*/NULL);
		StringBuilder_t * L_41 = V_1;
		Uri_t87E4A94B2901F5EEDD18AA72C3DB1B00E672D68E * L_42 = ___targetUri0;
		String_t* L_43 = Uri_get_Fragment_m111666DD668AC59B9F3C3D3CEEEC7F70F6904D41(L_42, /*hidden argument*/NULL);
		StringBuilder_Append_mDBB8CCBB7750C67BE2F2D92F47E6C0FA42793260(L_41, L_43, /*hidden argument*/NULL);
...
IL_0101:
	...
	{
		Uri_t87E4A94B2901F5EEDD18AA72C3DB1B00E672D68E * L_48 = ___targetUri0;
		String_t* L_49 = Uri_get_OriginalString_m56099E46276F0A52524347F1F46A2F88E948504F(L_48, /*hidden argument*/NULL);
		V_3 = L_49;
		goto IL_0129;
	}
...
IL_011d:
	{
		Uri_t87E4A94B2901F5EEDD18AA72C3DB1B00E672D68E * L_50 = ___targetUri0;
		String_t* L_51 = Uri_get_AbsoluteUri_m4326730E572E7E3874021E802813EB6F49F7F99E(L_50, /*hidden argument*/NULL);
		V_3 = L_51;
		goto IL_0129;
	}
